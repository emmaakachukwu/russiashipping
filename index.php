                        ...
                        <div class="col-xl-9 col-lg-9">
                            ...
                            <form action="./forms/index.php" method="post" class="search-box" id="search-form">
                                <div class="input-form">
                                    <input type="text" placeholder="Your Tracking ID" id="search-input" name="tracking_id" required>
                                </div>
                                <div class="search-form">
                                    <a href="javascript:void(0)" id="search-btn">Track & Trace</a>
                                </div>	
                            </form>	
                            <!-- Hero Pera -->
                            <div class="hero-pera">
                                <p id="search-error"><?php echo show_error() ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-caption mb-50">
                        ...
                        <div class="section-tittle mb-35">
                            ...
                            <h2><?php echo $app_name ?? '' ?> <br> Solutions That Saves our Valuable Time!</h2>
                        </div>
